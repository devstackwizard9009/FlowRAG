...
SESSION_TIMEOUT_SECONDS = int(os.getenv("FLOWRAG_SESSION_TIMEOUT", "86400"))
BACKGROUND_SESSION_TIMEOUT_SECONDS = int(
    os.getenv("FLOWRAG_BG_SESSION_TIMEOUT", "172800")
)
...
def _extract_display_name_from_desc(desc: str, fallback: str) -> str:
    ...
    Expected format: 'FlowRAG KB | display_name=<original_name>'
