...
class FlowRAG_MCP_Server(FastMCP):
    """Extended FastMCP server with FlowRAG-specific features.
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize FlowRAG MCP server.

        Args:
            name: Server name (default: "FlowRAG")
    ...
    def tool(
        ...
        **extra_kwargs: Any,
        ...
        """Register a tool with FlowRAG-specific output annotation support.
    ...
    def prompt(
        ...
        *,
        ...
        """Register a prompt with FlowRAG-specific output annotation support.
