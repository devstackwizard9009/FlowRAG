"""FlowRAG CLI - Beautiful command-line interface."""
...
# ASCII art logo - pixel block style (FlowRAG)
FLOWRAG_LOGO = r"""
███   ███ ███    █████████ ████████    █████   ████████    █████    ███████
███   ███ ███       ███    ███   ███  ███ ███  ███   ███  ███ ███  ███   ███
███   ███ ███       ███    ███   ███ ███   ███ ███   ███ ███   ███ ███
...
def create_info_table(
    pipeline_name: str,
    doc_url: str = "https://flowrag.openbmb.cn/",
    ...
    flowrag_ver = get_version_safe("flowrag")
    fastmcp_ver = get_version_safe("fastmcp")
    mcp_ver = get_version_safe("mcp")

    table.add_row("◆", "FlowRAG", Text(f"v{flowrag_ver}", style=STYLES["success"]))
...
def make_server_banner(
    ...
    """Create a formatted banner panel for FlowRAG server.

    Args:
        pipeline_name: Name of the pipeline
        show_logo: Whether to display the gradient logo (default: True)
        doc_url: Documentation URL (default: "https://flowrag.openbmb.cn/")
    ...
    flowrag_ver = get_version_safe("flowrag")
    title = get_gradient_text(" FlowRAG ")
    title.append(f"v{flowrag_ver} ", style=STYLES["muted"])
...
def make_welcome_banner() -> Panel:
    ...
    welcome_text.append(get_gradient_text("FlowRAG"))
    welcome_text.append(" - 新一代 RAG 开发框架\n", style=STYLES["secondary"])
    welcome_text.append("\n")
    welcome_text.append("  使用 ", style=STYLES["muted"])
    welcome_text.append("flowrag --help", style=STYLES["highlight"])
