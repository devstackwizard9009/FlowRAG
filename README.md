<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="./docs/flowrag_dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="./docs/flowrag.svg">
    <img alt="FlowRAG" src="./docs/flowrag.svg" width="55%">
  </picture>
</p>
...
<p align="center">
| 
<a href="https://flowrag.openbmb.cn/pages/en/getting_started/introduction"><b>Documentation</b></a> 
| 
<a href="https://modelscope.cn/datasets/FlowRAG/FlowRAG_Benchmark"><b>Dataset</b></a> 
| 
<a href="https://github.com/OpenBMB/FlowRAG/tree/rag-paper-daily/rag-paper-daily"><b>Paper Daily</b></a> 
| 
...
- [2026.01.23] 🎉 FlowRAG 3.0 Released: Say no to "black box" development—make every line of reasoning logic clearly visible 👉|[📖 Blog](https://github.com/OpenBMB/FlowRAG/blob/page/project/blog/en/flowrag3_0.md)|
...
- [2025.11.11] 🎉 FlowRAG 2.1 Released: Enhanced knowledge ingestion & multimodal support, with a more complete unified evaluation system!
- [2025.09.23] New daily RAG paper digest, updated every day 👉 |[📖 Papers](https://github.com/OpenBMB/FlowRAG/tree/rag-paper-daily/rag-paper-daily)|
- [2025.09.09] Released a Lightweight DeepResearch Pipeline local setup tutorial 👉 |[📺 bilibili](https://www.bilibili.com/video/BV1p8JfziEwM)|[📖 Blog](https://github.com/OpenBMB/FlowRAG/blob/page/project/blog/en/01_build_light_deepresearch.md)|
- [2025.09.01] Released a step-by-step FlowRAG installation and full RAG walkthrough video 👉 |[📺 bilibili](https://www.bilibili.com/video/BV1B9apz4E7K/?share_source=copy_web&vd_source=7035ae721e76c8149fb74ea7a2432710)|[📖 Blog](https://github.com/OpenBMB/FlowRAG/blob/page/project/blog/en/00_Installing_and_Running_RAG.md)|
- [2025.08.28] 🎉 FlowRAG 2.0 Released! FlowRAG 2.0 is fully upgraded: build a high-performance RAG with just a few dozen lines of code, empowering researchers to focus on ideas and innovation! We have preserved the FlowRAG v2 code, which can be viewed at [v2](https://github.com/OpenBMB/FlowRAG/tree/v2).
- [2025.01.23] FlowRAG Released! Enabling large models to better comprehend and utilize knowledge bases. The FlowRAG 1.0 code is still available at [v1](https://github.com/OpenBMB/FlowRAG/tree/v1).
...
<a href="https://trendshift.io/repositories/18747" target="_blank"><img src="https://trendshift.io/api/badge/repositories/18747" alt="OpenBMB%2FFlowRAG | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>

FlowRAG is the first lightweight RAG development framework based on the [Model Context Protocol (MCP)](https://modelcontextprotocol.io/docs/getting-started/intro) architecture design, jointly launched by [THUNLP](https://nlp.csai.tsinghua.edu.cn/) at Tsinghua University, [NEUIR](https://neuir.github.io) at Northeastern University, [OpenBMB](https://www.openbmb.cn/home), and [AI9stars](https://github.com/AI9Stars).
...
```shell
git clone https://github.com/OpenBMB/FlowRAG.git --depth 1
cd FlowRAG
```
...
- Core dependencies: If you only need to run basic core functions, such as only using FlowRAG UI:
  ```shell
  uv sync
  ```

- Full installation: If you want to fully experience FlowRAG's retrieval, generation, corpus processing, and evaluation functions, please run:
  ```shell
  uv sync --all-extras
  ```
...
**B: Install into an Existing Environment** To install FlowRAG into your currently active Python environment, use `uv pip`:
...
docker pull hdxin2002/flowrag:v0.3.0-base-cpu # Base version (CPU)
docker pull hdxin2002/flowrag:v0.3.0-base-gpu # Base version (GPU)
docker pull hdxin2002/flowrag:v0.3.0          # Full version (GPU)

# Option B: Build locally
docker build -t flowrag:v0.3.0 .
...
Note: After the container starts, FlowRAG UI will run automatically. You can directly access `http://localhost:5050` in your browser to use it.
...
```shell
flowrag run examples/sayhello.yaml
```
...
We provide complete tutorial examples from beginner to advanced. Whether you are conducting academic research or building industrial applications, you can find guidance here. Welcome to visit the [Documentation](https://flowrag.openbmb.cn/pages/en/getting_started/introduction) for more details.

### Research Experiments
Designed for researchers, providing data, experimental workflows, and visualization analysis tools.
- [Getting Started](https://flowrag.openbmb.cn/pages/en/getting_started/quick_start): Learn how to quickly run standard RAG experimental workflows based on FlowRAG.
- [Evaluation Data](https://flowrag.openbmb.cn/pages/en/develop_guide/dataset): Download the most commonly used public evaluation datasets in the RAG field and large-scale retrieval corpora, directly for research benchmark testing.
- [Case Analysis](https://flowrag.openbmb.cn/pages/en/develop_guide/case_study): Provides a visual Case Study interface to deeply track each intermediate output of the workflow, assisting in analysis and error attribution.
- [Code Integration](https://flowrag.openbmb.cn/pages/en/develop_guide/code_integration): Learn how to directly call FlowRAG components in Python code to achieve more flexible customized development.

### Demo Systems
Designed for developers and end users, providing complete UI interaction and complex application cases.
- [Quick Start](https://flowrag.openbmb.cn/pages/en/ui/start): Learn how to start FlowRAG UI and familiarize yourself with various advanced configurations in administrator mode.
- [Deployment Guide](https://flowrag.openbmb.cn/pages/en/ui/prepare): Detailed production environment deployment tutorials, covering the setup of Retriever, Generation models (LLM), and Milvus vector database.
- [Deep Research](https://flowrag.openbmb.cn/pages/en/demo/deepresearch): Flagship case, deploy a Deep Research Pipeline. Combined with the AgentCPM-Report model, it can automatically perform multi-step retrieval and integration to generate tens of thousands of words of survey reports.
...
<a href="https://github.com/OpenBMB/FlowRAG/contributors">
  <img src="https://contrib.rocks/image?repo=OpenBMB/FlowRAG&nocache=true" />
</a>
...
<a href="https://star-history.com/#OpenBMB/FlowRAG&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=OpenBMB/FlowRAG&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=OpenBMB/FlowRAG&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=OpenBMB/FlowRAG&type=Date" />
 </picture>
</a>

## Contact Us

- For technical issues and feature requests, please use [GitHub Issues](https://github.com/OpenBMB/FlowRAG/issues).
- For questions about usage, feedback, or any discussions related to RAG technologies, you are welcome to join our [WeChat group](https://github.com/OpenBMB/FlowRAG/blob/main/docs/wechat_qr.png), [Feishu group](https://github.com/OpenBMB/FlowRAG/blob/main/docs/feishu_qr.png), and [Discord](https://discord.gg/yRFFjjJnnS) to exchange ideas with us.
